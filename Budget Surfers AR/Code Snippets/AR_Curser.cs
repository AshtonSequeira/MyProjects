...
{
    [SerializeField] GameObject _curserChildObject,_TapToPlace;
    ...
    [SerializeField] GameObject _youWin, _Res;
    [SerializeField] GameObject _scanTheFloor;
